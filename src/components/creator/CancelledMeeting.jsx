...
import { getCancelledMeetings } from '../../store/slices/creatorMeetingSlice';
...
const CancelledMeeting = () => {
    ...
    const meetings = useSelector((state) => state.creatorMeeting.cancelledMeetings);
            ...
            {!isLoading && (
                <div className="min-h-screen bg-gray-100 p-6">
                    ...
                    {pageCount > 1 && (<ReactPaginate
                        ...
                        containerClassName={'pagination flex flex-wrap space-x-2 justify-center sm:justify-end'}
